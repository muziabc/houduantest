...
sudo mv $proj_home/deepexi-user-center-provider/target/deepexi-user-center-*.jar $proj_home/deepexi-user-center-provider/target/demo.jar # 兼容所有sh脚本
